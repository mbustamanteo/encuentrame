			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
									...
									<li class="dropdown" class="dropdown">
			                			<a href="index.php/ninos">Encuéntrame</a>
			              			</li>
			              			<li ><a href="index.php/about">¿Qué Hacemos?</a></li>
									<li class="dropdown">
	...
	<div id="wrapper">
    	...
    	<div class="container">
			...
			<div class="slider-wrapper">
				...
				<div id="da-slider" class="da-slider">
					<div class="da-slide">
						...
						<div class="da-img"><img src="img/parallax-slider/imac.png" alt="image01" /></div>
					</div>
					<div class="da-slide">
						<h2>Responsive Design</h2>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
						<a href="#" class="da-link">Read more</a>
						<div class="da-img"><img src="img/parallax-slider/ipad-mini.png" alt="image02" /></div>
					</div>
					<div class="da-slide">
						<h2>Over 1000 satisfied customers</h2>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
						<a href="#" class="da-link">Read more</a>
						<div class="da-img" style="margin-left: -150px"><img src="img/parallax-slider/mapa.png" alt="image03" /></div>
					</div>
					<div class="da-slide">
						<h2>HTML5</h2>
						<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
						<a href="#" class="da-link">Read more</a>
						<div class="da-img" style="margin-left: -100px"><img src="img/parallax-slider/html5.png" alt="image04" /></div>
					</div>
					<nav class="da-arrows">
      		...
      		<div class="row">
        		...
        		<div class="span3">
          			<div class="box">
						...
						<h3>Comentalo</h3>
						<p>
							Invita a tus amigos a apoyar esta causa 
						</p>
						<div class="clear"></div>
					</div>
        		</div>
				...
				<div class="span3">
          			<div class="box">
						...
						<h3>Reporta</h3>
						<p>
							Informa si tienes algun antecedente
						</p>
						<div class="clear"></div>
					</div>
        		</div>
			...
			<!-- start: Row -->
      		<div class="row">
        		...
        		<div class="span3">
					...
					<div class="title-out"><h3>Si encuentras un niño en la red...</h3></div>
					<ul class="check_list">
						<li>Haz click a la imagen del niño(a) que reconociste </li>
						<li>Reporta en la misma dirección su ubicación y datos</li>
						<li>Informa a la policia</li>
					</ul>
					<!-- end: List Style -->
			...
			<div class="row">
				...
				<div class="span8">
					<div class="title-out"><h3>Sobre nosotros</h3></div>
					<p>
				...
				<div class="span4">
					<div class="title-out"><h3>Video</h3></div>
					<div class="flex-video widescreen">
						<iframe src="http://player.vimeo.com/video/6686768?title=0&byline=0&portrait=0" width="1500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
					</div>
				</div>	
			...
			<div class="row">
				...
				<div class="span9">
					...
					<div id="under-footer-copyright">
						&copy; 2012, <a href="http://bucala.co">BUCALA</a>. Designed by <a href="http://bucala.co">BUCALA</a> in Chile <img src="img/poland.png" alt="Poland" style="margin-top:-4px">
					</div>
